...
static Initialiser5 initialiser5;
...
struct Initialiser7
{
    Initialiser7()
    {
	p_polygon.peripheries = 1;
	p_ellipse.peripheries = 1;
	p_ellipse.sides=1;
	p_circle.regular = true;
	p_circle.peripheries = 1;
	p_circle.sides = 1;
	p_egg.peripheries = 1;
	p_egg.sides = 1;
	p_egg.distortion = -0.3;
	p_triangle.peripheries = 1;
	p_triangle.sides = 3;
	p_box.peripheries = 1;
	p_box.sides = 4;
	p_square.regular = true;
	p_square.peripheries = 1;
	p_square.sides = 4;
	p_plaintext.sides = 4;
	p_plain.sides = 4;
	p_diamond.peripheries = 1;
	p_diamond.sides = 4;
	p_diamond.orientation = 45.0;
	p_trapezium.peripheries = 1;
	p_trapezium.sides = 4;
	p_trapezium.distortion = -0.4;
	p_parallelogram.peripheries = 1;
	p_parallelogram.sides = 4;
	p_parallelogram.skew = 0.6;
	p_house.peripheries = 1;
	p_house.sides = 5;
	p_house.distortion = -0.64;
	p_pentagon.peripheries = 1;
	p_pentagon.sides = 5;
	p_hexagon.peripheries = 1;
	p_hexagon.sides = 6;
	p_septagon.peripheries = 1;
	p_septagon.sides = 7;
	p_octagon.peripheries = 1;
	p_octagon.sides = 8;
	p_note.peripheries = 1;
	p_note.sides = 4;
	p_note.option = DOGEAR;
	p_tab.peripheries = 1;
	p_tab.sides = 4;
	p_tab.option = TAB;
	p_folder.peripheries = 1;
	p_folder.sides = 4;
	p_folder.option = FOLDER;
	p_box3d.peripheries = 1;
	p_box3d.sides = 4;
	p_box3d.option = BOX3D;
	p_component.peripheries = 1;
	p_component.sides = 4;
	p_component.option = COMPONENT;
	p_underline.peripheries = 1;
	p_underline.sides = 4;
	p_underline.option = UNDERLINE;
	p_cylinder.peripheries = 1;
	p_cylinder.sides = 19;
	p_cylinder.option = CYLINDER;
	p_cylinder.vertices = (pointf*)&cylinder_gen;
	p_doublecircle.regular = true;
	p_doublecircle.peripheries = 2;
	p_doublecircle.sides = 1;
	p_invtriangle.peripheries = 1;
	p_invtriangle.sides = 3;
	p_invtriangle.orientation = 180.0;
	p_invtrapezium.peripheries = 1;
	p_invtrapezium.sides = 4;
	p_invtrapezium.orientation = 180.0;
	p_invtrapezium.distortion = -0.4;
	p_invhouse.peripheries = 1;
	p_invhouse.sides = 5;
	p_invhouse.orientation = 180.0;
	p_invhouse.distortion = -0.64;
	p_doubleoctagon.peripheries = 2;
	p_doubleoctagon.sides = 8;
	p_tripleoctagon.peripheries = 3;
	p_tripleoctagon.sides = 8;
	p_Mdiamond.peripheries = 1;
    p_Mdiamond.sides = 4;
    p_Mdiamond.orientation = 45.0;
    p_Mdiamond.option = DIAGONALS | AUXLABELS;
	p_Msquare.regular = true;
	p_Msquare.peripheries = 1;
	p_Msquare.sides = 4;
	p_Msquare.option = DIAGONALS;
	p_Mcircle.regular = true;
    p_Mcircle.peripheries = 1;
    p_Mcircle.sides = 1;
    p_Mcircle.option = DIAGONALS | AUXLABELS;
	p_star.peripheries = 1;
	p_star.sides = 10;
	p_star.vertices = (pointf *)&star_gen;
	p_promoter.peripheries = 1;
	p_promoter.sides = 4;
	p_promoter.option = PROMOTER;
	p_cds.peripheries = 1;
	p_cds.sides = 4;
	p_cds.option = CDS;
	p_terminator.peripheries = 1;
	p_terminator.sides = 4;
	p_terminator.option = TERMINATOR;
	p_utr.peripheries = 1;
	p_utr.sides = 4;
	p_utr.option = UTR;
	p_insulator.peripheries = 1;
	p_insulator.sides = 4;
	p_insulator.option = INSULATOR;
	p_ribosite.peripheries = 1;
	p_ribosite.sides = 4;
	p_ribosite.option = RIBOSITE;
	p_rnastab.peripheries = 1;
	p_rnastab.sides = 4;
	p_rnastab.option = RNASTAB;
	p_proteasesite.peripheries = 1;
	p_proteasesite.sides = 4;
	p_proteasesite.option = PROTEASESITE;
	p_proteinstab.peripheries = 1;
	p_proteinstab.sides = 4;
	p_proteinstab.option = PROTEINSTAB;
	p_primersite.peripheries = 1;
	p_primersite.sides = 4;
	p_primersite.option = PRIMERSITE;
	p_restrictionsite.peripheries = 1;
	p_restrictionsite.sides = 4;
	p_restrictionsite.option = RESTRICTIONSITE;
	p_fivepoverhang.peripheries = 1;
	p_fivepoverhang.sides = 4;
	p_fivepoverhang.option = FIVEPOVERHANG;
	p_threepoverhang.peripheries = 1;
	p_threepoverhang.sides = 4;
	p_threepoverhang.option = THREEPOVERHANG;
	p_noverhang.peripheries = 1;
	p_noverhang.sides = 4;
	p_noverhang.option = NOVERHANG;
	p_assembly.peripheries = 1;
	p_assembly.sides = 4;
	p_assembly.option = ASSEMBLY;
	p_signature.peripheries = 1;
	p_signature.sides = 4;
	p_signature.option = SIGNATURE;
	p_rpromoter.peripheries = 1;
	p_rpromoter.sides = 4;
	p_rpromoter.option = RPROMOTER;
	p_rarrow.peripheries = 1;
	p_rarrow.sides = 4;
	p_rarrow.option = RARROW;
	p_larrow.peripheries = 1;
	p_larrow.sides = 4;
	p_larrow.option = LARROW;
	p_lpromoter.peripheries = 1;
	p_lpromoter.sides = 4;
	p_lpromoter.option = LPROMOTER;
    }
};

static Initialiser7 initialiser7;
...
static void poly_free(node_t * n)
{
    polygon_t *p = (polygon_t*) ND_shape_info(n);
...
static void record_free(node_t * n)
{
    field_t *p = (field_t*) ND_shape_info(n);
